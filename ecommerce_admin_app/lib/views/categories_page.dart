                  ...
                  return AlertDialog(
                    ...
                    actions: [
                      TextButton(onPressed: () {
                        ...
                        showDialog(context: context, builder: (context) {
                          return AdditionalConfirm(contentText: "Are you sure you want to delete this category?", onYes: () {
                      ...
                      TextButton(onPressed: () {
                        Navigator.pop(context);
                        showDialog(context: context, builder: (context) => ModifyCategory(isUpdating: true, categoryId: categories[index].id, priority: categories[index].priority, image: categories[index].image, name: categories[index].name,),);
      ...
      content: SingleChildScrollView(
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text("All data will be converted to lowercase"),
              SizedBox(height: 10,),
              TextFormField(
                controller: categoryController,
                validator: (v) => v!.isEmpty ? "This field can't be empty." : null,
              ...
              TextFormField(
                ...
                // validator: (v) => v!.isEmpty ? "This filed can't be empty" : null,
                decoration: InputDecoration(
                  hintText: "Image Link",
